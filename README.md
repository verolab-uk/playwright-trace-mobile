...
This repository publishes one reusable mobile trace viewer runtime. The CD workflow builds `packages/trace-viewer`, packages `packages/playwright-core/lib/vite/traceViewer`, and publishes `trace-viewer.tar.gz` to this public repository release at `https://github.com/verolab-uk/playwright-trace-mobile/releases/download/trace-viewer-latest/trace-viewer.tar.gz`.
